...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        //After adding details it will automatically fatch the data and genrate
            ...
            try {
                ...
                String query = null;
                 if (atype.equals("Admin")) {
                   query = "insert into login values('"+smeter+"', '"+susername+"', '"+sname+"', '"+spassword+"', '"+atype+"')"; //DML
