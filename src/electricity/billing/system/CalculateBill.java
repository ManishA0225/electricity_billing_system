...
public class CalculateBill extends JFrame implements ActionListener{
    JTextField ftname, ftaddress, ftcity, ftstate, ftunits, ftemail, ftphone;
    JButton next, cancel;
   ...
   CalculateBill(){
        ...
        //dynamically fatching the meter number in database
        meternumber = new Choice();
        try{
            //estalish the Connection for that making conn class object
            Conn c = new Conn();
            //storing data in ResultSet
            ResultSet rs = c.s.executeQuery("select * from customer");
            //Looping the data
            while(rs.next()){
                //getString is use for getting a paticular coloumn
        ...
        ftunits = new JTextField();
        ftunits.setBounds(240, 200, 200, 20);
        p.add(ftunits);
